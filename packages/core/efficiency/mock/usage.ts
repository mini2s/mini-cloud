...
export function getMockUsageDeptModels(_q: DeptQuery): DeptModelsResp {
  ...
  const autoRouting: AutoRoutingItem[] = [
    { routed_model: MODEL_NAMES[0]!, request_count: 5240, request_pct: 0.6095 },
    { routed_model: MODEL_NAMES[1]!, request_count: 2120, request_pct: 0.2465 },
    { routed_model: MODEL_NAMES[2]!, request_count: 1240, request_pct: 0.1441 },
  ];
...
export function getMockUsageDeptResults(_q: DeptQuery): DeptResultsResp {
  ...
  return {
    ...
    success_rate: successRequests / totalRequests,
...
export function getMockUsageUserDetail(
  ...
  const autoRouting: AutoRoutingItem[] = [
    { routed_model: MODEL_NAMES[0]!, request_count: 620, request_pct: 0.5313 },
    { routed_model: MODEL_NAMES[1]!, request_count: 320, request_pct: 0.2740 },
    { routed_model: MODEL_NAMES[2]!, request_count: 228, request_pct: 0.1952 },
  ];
