...
vi.mock("@multica/core/paths", () => ({
  ...
  useWorkspacePaths: () => ({
    ...
    efficiencySettings: () => "/acme/settings/efficiency",
    home: () => "/acme/home",
    ...
    quotas: () => "/acme/quotas",
    meProfile: () => "/acme/me/profile",
    meQuota: () => "/acme/me/quota",
    meNotifications: () => "/acme/me/notifications",
    meDevices: () => "/acme/me/devices",
