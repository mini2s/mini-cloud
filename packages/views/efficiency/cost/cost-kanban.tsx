...
// (NO URL query state). Layout mirrors UsageKanban: PageHeader (title +
// period select) → left dept tree panel (reused from the usage dimension)
// + right main area (view tabs + include_children switch + dispatched
// content).
//
