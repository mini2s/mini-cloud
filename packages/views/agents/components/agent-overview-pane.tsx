...
const TAB_LABEL_KEY: Record<DetailTab, "activity" | "tasks" | "instructions" | "skills" | "plugin" | "environment" | "custom_args" | "mcp_config" | "integrations"> = {
  activity: "activity",
  tasks: "tasks",
  ...
  return (
    ...
    <div className="flex min-h-[60vh] flex-col overflow-hidden rounded-lg border bg-background md:h-full md:min-h-0">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        ...
        {SKILLS_ENABLED && effectiveTab === "skills" && (
          <TabContent>
