 ...
 *
 * Manual-mode `isExpanded` is lifted up because it drives
 * `DialogContent`'s className — the className lives here in the shell
 * since the Popup is here, but the toggle for that state lives in the
 * manual panel body.
 */
