...
SELECT * FROM multica_lark_installation WHERE id = $1;

-- name: GetLarkInstallationInWorkspace :one
SELECT * FROM multica_lark_installation
...
SELECT * FROM multica_lark_installation WHERE app_id = $1;
...
SELECT * FROM multica_lark_user_binding
...
-- row matches.
SELECT * FROM multica_lark_chat_session_binding
...
SELECT * FROM multica_lark_inbound_audit
WHERE installation_id = $1
...
SELECT * FROM multica_lark_outbound_card_message
WHERE task_id = $1;
