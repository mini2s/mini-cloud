...
WHERE issue_id = $1
  ...
  AND created_at > $3
  AND id <> $4
  AND NOT (author_type = 'multica_agent' AND author_id = $5)
`
...
SELECT c.id, c.issue_id, c.author_type, c.author_id, c.content, c.type, c.created_at, c.updated_at, c.parent_id, c.workspace_id, c.resolved_at, c.resolved_by_type, c.resolved_by_id FROM multica_comment c
...
func (q *Queries) GetThreadRoot(ctx context.Context, arg GetThreadRootParams) (MulticaComment, error) {
...
WHERE parent_id = $1 AND author_type = 'multica_agent' AND author_id = $2
`
