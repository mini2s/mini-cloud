...
INSERT INTO multica_agent (
    ...
    ('dd0683f4-d72c-4b49-8030-827f5b15df2e', NULL, '产品经理', '需求梳理', NULL, 'local',
     '{}'::jsonb, NULL, 'workspace', 'idle', 6,
     NULL, '你是一个产品经理，按要求进行需求梳理', '{}'::jsonb, '[]'::jsonb, NULL,
    ...
    ('c0bea924-c78f-43b1-8d50-449ec3c6b4cf', NULL, '研发工程师', 'TDD 编码', NULL, 'local',
     '{}'::jsonb, NULL, 'workspace', 'idle', 6,
     NULL, '', '{}'::jsonb, '[]'::jsonb, NULL,
    ...
    ('24a981c1-6ea6-4eab-9225-a5fe3da64477', NULL, 'DevOps 工程师', '集成验证', NULL, 'local',
     '{}'::jsonb, NULL, 'workspace', 'idle', 6,
     NULL, '', '{}'::jsonb, '[]'::jsonb, NULL,
