...
INSERT INTO multica_agent (
    ...
    ('dd0683f4-d72c-4b49-8030-827f5b15df2e', NULL, '需求分析师', '需求梳理', NULL, 'local',
     '{}'::jsonb, NULL, 'workspace', 'idle', 6,
     NULL, '你是一个需求分析师，按要求进行需求梳理', '{}'::jsonb, '[]'::jsonb, NULL,
     NULL, NULL, 'fa87f958-9229-442b-8bc3-4b22a4d6f806', TRUE),

    ('5e2fccac-6257-4ea5-ac7a-a5d8a4765917', NULL, '架构师', '方案设计', NULL, 'local',
     '{}'::jsonb, NULL, 'workspace', 'idle', 6,
     NULL, '', '{}'::jsonb, '[]'::jsonb, NULL,
     NULL, NULL, '365d045e-8487-467f-94e6-8237fa97f4a6', TRUE),

    ('4348e20d-eadc-4095-ac7a-cd480e927375', NULL, '项目经理', '任务拆解', NULL, 'local',
     '{}'::jsonb, NULL, 'workspace', 'idle', 6,
     NULL, '', '{}'::jsonb, '[]'::jsonb, NULL,
     NULL, NULL, '8fabc295-cd8d-4514-9230-a00bc880a4bb', TRUE),

    ('c0bea924-c78f-43b1-8d50-449ec3c6b4cf', NULL, '开发工程师', 'TDD 编码', NULL, 'local',
     '{}'::jsonb, NULL, 'workspace', 'idle', 6,
     NULL, '', '{}'::jsonb, '[]'::jsonb, NULL,
     NULL, NULL, '665b5bbf-b859-498a-826f-9584322c2a42', TRUE),

    ('67cdded4-c49f-4fc3-b7e0-52aa2038db91', NULL, '测试工程师', '测试生成', NULL, 'local',
     '{}'::jsonb, NULL, 'workspace', 'idle', 6,
     NULL, '', '{}'::jsonb, '[]'::jsonb, NULL,
     NULL, NULL, '10a3b7d2-1af0-41bc-9d9c-9ed812e230f4', TRUE),

    ('24a981c1-6ea6-4eab-9225-a5fe3da64477', NULL, '质量工程师', '集成验证', NULL, 'local',
     '{}'::jsonb, NULL, 'workspace', 'idle', 6,
     NULL, '', '{}'::jsonb, '[]'::jsonb, NULL,
     NULL, NULL, '5d54963c-9bb5-4373-9e33-721898452d78', TRUE),

    ('a6f5d437-93c2-4623-ba0a-bcbb5cb8d1a6', NULL, '审核员', '审核验证', NULL, 'local',
     '{}'::jsonb, NULL, 'workspace', 'idle', 6,
