-- Persist whether a PR ↔ multica_issue link was created with explicit closing intent
...
-- closing later still resolves an multica_issue that an earlier closing-keyword PR
-- had blocked from advancing.
ALTER TABLE multica_issue_pull_request
