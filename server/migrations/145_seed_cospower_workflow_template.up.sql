...
-- 技术负责人 is the critic on every regular node. The Task Split reviewer is
-- assigned to the workflow creator when an instance is cloned.
...
BEGIN
    ...
    -- the workflow creator reviews it, and each approved child task spawns its own issue.
