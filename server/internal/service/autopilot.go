...
func (s *AutopilotService) dispatchCreateIssue(ctx context.Context, ap db.MulticaAutopilot, run *db.MulticaAutopilotRun, triggerTimezone string) error {
...
func formatAutopilotRunTimestamp(run db.MulticaAutopilotRun, timezone string) string {
...
func formatAutopilotRunDate(run db.MulticaAutopilotRun, timezone string) string {
	triggeredAt := autopilotRunTriggeredAt(run)
	loc, _ := autopilotTriggerLocation(timezone)
	return triggeredAt.In(loc).Format("2006-01-02")
}

func autopilotRunTriggeredAt(run db.MulticaAutopilotRun) time.Time {
...
func (s *AutopilotService) buildIssueDescription(ap db.MulticaAutopilot, run db.MulticaAutopilotRun, triggerTimezone string) pgtype.Text {
...
func (s *AutopilotService) interpolateTemplate(ap db.MulticaAutopilot, run db.MulticaAutopilotRun, triggerTimezone string) string {
...
func (s *AutopilotService) canCreatorAccessPrivateLeader(ctx context.Context, ap db.MulticaAutopilot, leader db.MulticaAgent) bool {
