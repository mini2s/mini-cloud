	...
	rows := []db.ListActiveWorkflowRoleCandidateMembersRow{
		{
			MemberID:            member1,
			UserID:              user1,
			ExternalUniversalID: pgtype.Text{String: " universal-1 ", Valid: true},
			ExternalUserID:      pgtype.Text{String: "legacy-1", Valid: true},
			DisplayName:         " Alice ",
		},
		{
			MemberID:       member2,
			UserID:         user2,
			ExternalUserID: pgtype.Text{String: "legacy-2", Valid: true},
			DisplayName:    "Bob",
		},
		{
			MemberID:            member3,
			UserID:              user3,
			ExternalUniversalID: pgtype.Text{String: "duplicate", Valid: true},
			DisplayName:         "Carol",
		},
		{
			MemberID:            member4,
