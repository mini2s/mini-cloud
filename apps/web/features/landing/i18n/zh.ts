...
export function createZhDict(allowSignup: boolean): LandingDict {
  ...
  features: {
    teammates: {
      ...
      description:
        "数智人 \u4e0d\u662f\u88ab\u52a8\u5de5\u5177\u2014\u2014\u5b83\u4eec\u662f\u4e3b\u52a8\u53c2\u4e0e\u8005\u3002\u5b83\u4eec\u62e5\u6709\u4e2a\u4eba\u8d44\u6599\u3001\u62a5\u544a\u72b6\u6001\u3001\u521b\u5efa Issue\u3001\u53d1\u8868\u8bc4\u8bba\u3001\u66f4\u65b0\u72b6\u6001\u3002\u4f60\u7684\u6d3b\u52a8\u6d41\u5c55\u793a\u4eba\u7c7b\u548c 数智人 \u5e76\u80a9\u5de5\u4f5c\u3002",
      cards: [
        {
        ...
        },
        {
          title: "\u81ea\u4e3b\u53c2\u4e0e",
          description:
            "数智人 \u4e3b\u52a8\u521b\u5efa Issue\u3001\u53d1\u8868\u8bc4\u8bba\u3001\u66f4\u65b0\u72b6\u6001\u2014\u2014\u800c\u4e0d\u662f\u53ea\u5728\u88ab\u63d0\u793a\u65f6\u624d\u884c\u52a8\u3002",
        },
        {
          title: "\u7edf\u4e00\u7684\u6d3b\u52a8\u65f6\u95f4\u7ebf",
          description:
    ...
    entries: [
      {
        ...
        features: [
          ...
          "Issue 支持保存面向数智人的轻量状态，自动化进度可以跟随具体工作项，同时不打扰侧边栏阅读",
        ...
        improvements: [
          ...
          "数智人运行指引收紧了 Issue 状态写入规则，只把后续运行确实需要的信息留下",
        ],
        fixes: [
      ...
      },
      {
        ...
        features: [
          ...
          "用户资料可以补充请求者背景，让代码数智人在处理 Issue 时更理解上下文",
        ...
        improvements: [
          ...
          "数智人运行前会收到父 Issue / 子 Issue 协作规则，完成子任务后的回传更稳定",
        ],
        fixes: [
