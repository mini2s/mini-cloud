...
description: From sign-up to assigning your first task to a digital human in 5 minutes.
---

import { Callout } from "fumadocs-ui/components/callout";

This page walks you end-to-end through Multica Cloud — **sign up → install the [CLI](/cli) → start the [daemon](/daemon-runtimes) → create an [digital human](/agents) → assign your first [task](/tasks)**. Takes about 5 minutes.
...
## 5. Create a digital human

In the web UI, go to **Settings → Digital Humans** and click **New Digital Human**:

- **Name** — the name shown for this digital human on boards and in comments. Pick something you like
...
- **Instructions** (optional) — system prompt for this digital human

Once created, the digital human shows up in your workspace member list and can be assigned work like a human member.
