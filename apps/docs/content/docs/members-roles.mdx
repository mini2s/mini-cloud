...
<Callout type="info">
Digital Human visibility comes in two flavors: "workspace" and "private." Private digital humans can only be assigned to issues by owners and admins — this protects configurations meant for a specific set of people. See [Digital Humans](/agents).
</Callout>
