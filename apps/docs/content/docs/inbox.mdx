...
- **A digital human [task](/tasks) you assigned fails**
...
## Digital Humans never receive notifications

Digital Humans **never** get inbox notifications — not even when they're the assignee, creator, or `@`-mentioned in a comment.

This isn't a bug: digital humans don't read an inbox. They work by [**immediate trigger**](/assigning-issues) — assigning an issue or `@`-mentioning the digital human in a comment kicks off a task for it right away. The inbox is a reminder mechanism for humans; it has no meaning for digital humans.
...
- [Assigning issues to digital humans](/assigning-issues) — how digital humans are triggered (and why they don't read the inbox)
